...
def extract_key_frames(video_path, threshold=30, min_contour_area=500):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold', type=int, default=30, help='Threshold for detecting motion')
